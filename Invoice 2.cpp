...
int main() {
	cout << "\t\t\t PRICE" <<endl;
	cout << "-------------------------------------------------------------" <<endl<<endl;
	Invoice Invoice1("LE1310","Iphone X",2,11100000);
	Invoice Invoice2("FA2910","Iphone 8",3,7400000);
	...
	cout << "PRICE TOTAL INVOICE 2 adalah Rp. "<< Invoice1.getInvoiceAmount()<<",-" <<endl<<endl;
